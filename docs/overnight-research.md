...
- 2026-08-31 Python BM25 drop-in (`scratch/bm25-custom`, same tokenizer/AND/OR/field weights). Turn-1 gold-in-81: enter_fts 115, enter_py 117, miss_enter 6, leave_hits 4. Skip full eval. Do not retry a from-scratch Okapi scorer.
- 2026-08-31 one-way hyponym: drop AND `shoes` when query has clog/mule/loafer, OR the parent. Turn-1 gold-in-81 identical to freeze (115/115, miss_enter 0, leave_hits 0). No-op. Do not retry one-way shoes hyponym on this public set.
